...
storage_account_name  = "reactstaticwebapp"
acr_name              = "reactexpressacr"
backend_app_name      = "react-express-backend"
sql_server_name       = "react-express-db"
sql_database_name     = "react-express-db"
sql_admin_user        = "expressadmin"
sql_admin_password    = "2508Moni!"
db_connection_string  = "Server=tcp:react-express-db.database.windows.net,3306;Initial Catalog=react-express-db;Persist Security Info=False;User ID=expressadmin;Password=2508Moni!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
image_tag = "v1"
